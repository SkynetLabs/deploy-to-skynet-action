...
import { hexToUint8Array, trimUriPrefix, toHexString, stringToUint8ArrayUtf8, uint8ArrayToStringUtf8, } from "./utils/string";
 ...
 */
export async function getOrCreateSkyDBRegistryEntry(client, dataKey, data, revision, customOptions) {
 ...
 */
export function incrementRevision(revision) {
 ...
 */
export function validateEntryData(data, allowDeletionEntryData) {
