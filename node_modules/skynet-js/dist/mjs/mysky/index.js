...
import { deleteEntryData as deleteEntryDataV2, deleteJSON as deleteJSONV2, getEntryData as getEntryDataV2, getEntryLink as getEntryLinkV2, getJSONEncrypted as getJSONEncryptedV2, getJSON as getJSONV2, setDataLink as setDataLinkV2, setEntryData as setEntryDataV2, setJSONEncrypted as setJSONEncryptedV2, setJSON as setJSONV2, } from "./skydb_v2";
...
export class MySky {
    ...
    constructor(connector, permissions, hostDomain, currentPortalUrl) {
        ...
        this.getEntryLink = getEntryLink;
        this.setJSON = setJSON;
        this.deleteJSON = deleteJSON;
        this.setDataLink = setDataLink;
        this.getEntryData = getEntryData;
        this.setEntryData = setEntryData;
        this.deleteEntryData = deleteEntryData;
        this.getJSONEncrypted = getJSONEncrypted;
        this.setJSONEncrypted = setJSONEncrypted;
        // v2
        this.dbV2 = {
    ...
    async redirectIfNotOnPreferredPortal() {
        ...
        if (preferredPortalUrl === null) {
            ...
            const newUrl = await getRedirectUrlOnPreferredPortal(currentDomainClient, window.location.hostname, preferredPortalUrl);
