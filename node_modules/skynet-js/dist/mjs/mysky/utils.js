 ...
 */
export async function getRedirectUrlOnPreferredPortal(client, currentUrl, preferredPortalUrl) {
 ...
 */
export function shouldRedirectToPreferredPortalUrl(currentDomain, preferredPortalUrl) {
