...
async function deleteJSON(path, customOptions) {
    ...
    await this.setEntryData(path, skydb_v2_1.DELETION_ENTRY_DATA, { ...opts, allowDeletionEntryData: true });
}
...
async function deleteEntryData(path, customOptions) {
    ...
    await this.setEntryData(path, skydb_v2_1.DELETION_ENTRY_DATA, { ...customOptions, allowDeletionEntryData: true });
}
