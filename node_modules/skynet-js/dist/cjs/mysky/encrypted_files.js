 ...
 */
exports.ENCRYPTION_PATH_SEED_LENGTH = 32;
...
function deriveEncryptedFileKeyEntropy(pathSeed) {
    const bytes = new Uint8Array([...(0, crypto_1.sha512)(SALT_ENCRYPTION), ...(0, crypto_1.sha512)(pathSeed)]);
...
function deriveEncryptedFileTweak(pathSeed) {
    let hashBytes = (0, crypto_1.sha512)(new Uint8Array([...(0, crypto_1.sha512)(SALT_ENCRYPTED_TWEAK), ...(0, crypto_1.sha512)(pathSeed)]));
...
function deriveEncryptedFileSeed(pathSeed, subPath, isDirectory) {
    ...
    return (0, string_1.toHexString)(pathSeedBytes.slice(0, exports.ENCRYPTION_PATH_SEED_LENGTH));
}
