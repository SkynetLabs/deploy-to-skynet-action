...
function makeUrl(...args) {
    ...
    return args.reduce((acc, cur) => (0, url_join_1.default)(acc, cur));
}
...
function getFullDomainUrlForPortal(portalUrl, domain) {
    ...
    domain = (0, string_1.trimUriPrefix)(domain, exports.uriSkynetPrefix);
